...
export async function sendScanComplete(scan, projectName, appUrl, webhookUrl) {
    const message = {
...
export async function sendCriticalFinding(finding, projectName, appUrl, webhookUrl) {
    const message = {
