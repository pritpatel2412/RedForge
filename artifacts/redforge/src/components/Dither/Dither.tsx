...
function DitheredWaves({
  ...
  // Window-level mouse listener — fires even when the cursor is over HTML
  // elements layered on top of the canvas (nav, headings, buttons, etc.)
  useEffect(() => {
...
export default function Dither({
  ...
  return (
    <Canvas
      ...
      dpr={1}
      gl={{ antialias: true, preserveDrawingBuffer: true, failIfMajorPerformanceCaveat: false }}
    >
      <DitheredWaves
        waveSpeed={waveSpeed}
